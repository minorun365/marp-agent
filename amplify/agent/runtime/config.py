...
3. 1スライド1メッセージに絞る。通常スライドは「見出し1行＋本文4〜6要素」を目安にし、箇条書き・表・小見出し・本文を内容に合わせて使い分ける。短い箇条書きだけで情報を薄くしない
...
- 通常スライドは「見出し1行＋箇条書き4項目まで」を基準にする。説明文を1〜2行置く場合は、箇条書きを3項目へ減らす
...
- はみ出しと枚数違いが同時に指摘された場合は、はみ出しの解消を最優先にしたうえで、指定枚数へそろえる
"""

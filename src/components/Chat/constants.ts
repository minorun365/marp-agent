...
export const TIPS = [
  ...
  'このアプリはAWSのBedrock AgentCoreとLambda Web Adapterでフルサーバーレス構築されています。',
  'このアプリの裏では、Strands Agentsフレームワークで構築されたAIエージェントが稼働しています。',
  'このアプリはサーバーレス構成なので維持費が激安！かかる費用はほぼ推論時のAPI料金のみです。',
  '現在は、Amazon BedrockのGrok 4.6を標準モデルとして使用しています。',
...
export const MESSAGES = {
  ...
  ERROR_MODEL_THROTTLED: 'モデルが高負荷のようです。しばらく待ってからもう一度お試しください。',

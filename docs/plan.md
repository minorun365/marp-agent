...
一般公開版をこのリポジトリの `main` で管理し、テーマや認証制限などが異なる派生版は必要に応じて別リポジトリで管理する。

| リポジトリ | 用途 | 認証 |
|------------|------|------|
| 一般公開版 | 誰でも利用できる公開アプリ | 誰でも登録可 |
| 派生版 | テーマや利用条件が異なる別用途 | 派生版側で管理 |

### 変更反映の責務

| 変更内容 | 作業場所 | 反映方法 |
|---------|----------|---------|
| 共通のバグ修正・機能追加 | 一般公開版 | 必要な派生版へ cherry-pick |
| 一般公開版のドキュメント更新 | 一般公開版 | 公開してよい内容のみ記載 |
| 派生版固有（テーマ、ドメイン、認証制限） | 派生版 | 派生版のみに保持 |
...
- 共通機能は一般公開版で開発し、必要に応じて派生版へ cherry-pick する

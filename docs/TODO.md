...
|---|--------|------|------|--------|-----------|-----------|----------|----------|
| #44 | アプリのタイトルに#をつけたい | 10分 | ⬜ 未着手 | 🔴 重要 | ⬜ | ➖ | ⬜ | ➖ |
| #46 | Haikuモードも足したい | 20分 | ⬜ 未着手 | | ⬜ | ⬜ | ➖ | ➖ |
| #41 | スライドデザイン選択UIのデザイン改善 | 30分 | ⬜ 未着手 | 🔴 重要 | ⬜ | ⬜ | ⬜ | ➖ |
...
**概要**: アプリのタイトル「パワポ作るマン」の前に「#」をつけて「#パワポ作るマン」にしたい。ハッシュタグ風のデザインにすることでSNS映えする。

**修正箇所**: タイトルが表示されている箇所（Header、ページタイトルなど）
